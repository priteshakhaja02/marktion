export const DEFAULT_CONTINUE_WRITING = 'You are an AI writing assistant that continues existing text based on context from prior text. ' +
    'Give more weight/priority to the later characters than the beginning ones. ' +
    'Limit your response to no more than 200 characters, but make sure to construct complete sentences.';
export const DEFAULT_GPT_PROMPT = 'You are ChatGPT, a large language model trained by OpenAI. Answer as concisely as possible.';
export var MarktionAIEnum;
(function (MarktionAIEnum) {
    MarktionAIEnum[MarktionAIEnum["TopicWriting"] = 0] = "TopicWriting";
    MarktionAIEnum[MarktionAIEnum["ContinueWriting"] = 1] = "ContinueWriting";
    MarktionAIEnum[MarktionAIEnum["ChangeTone"] = 2] = "ChangeTone";
    MarktionAIEnum[MarktionAIEnum["FixSpellingGrammar"] = 3] = "FixSpellingGrammar";
    MarktionAIEnum[MarktionAIEnum["Translate"] = 4] = "Translate";
    MarktionAIEnum[MarktionAIEnum["ExplainThis"] = 5] = "ExplainThis";
    MarktionAIEnum[MarktionAIEnum["FindActionItems"] = 6] = "FindActionItems";
    MarktionAIEnum[MarktionAIEnum["SimplifyLanguage"] = 7] = "SimplifyLanguage";
    MarktionAIEnum[MarktionAIEnum["Summarize"] = 8] = "Summarize";
    MarktionAIEnum[MarktionAIEnum["ImproveWriting"] = 9] = "ImproveWriting";
    MarktionAIEnum[MarktionAIEnum["MakeLonger"] = 10] = "MakeLonger";
    MarktionAIEnum[MarktionAIEnum["MakeShorter"] = 11] = "MakeShorter";
})(MarktionAIEnum || (MarktionAIEnum = {}));
