...
export const SuggestionPluginKey = new PluginKey('plugin-suggestion');
export const defaultAllow = ({ transaction, match }) => {
    return Boolean(transaction.docChanged && match);
};
export function suggestion({ pluginKey = SuggestionPluginKey, char = '@', allowSpaces = false, allowedPrefixes = [' '], startOfLine = false, decorationTag = 'span', decorationClass = 'suggestion', allow = defaultAllow, onAttach, onChange, onKeyDown }) {
    let props;
    let editorView = null;
