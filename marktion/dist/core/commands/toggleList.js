...
import { isList, getNodeType, findParentNode } from '../helpers';
...
export const toggleList = (listTypeOrName, itemTypeOrName, keepMarks, attributes = {}) => ({ tr, state, dispatch, chain, commands, can }) => {
